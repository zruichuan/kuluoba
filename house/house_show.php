...
<div id="myPrintArea">
  ...
  <div class="house_messages_3">
    <ul>
      ...
      <li><span>ジ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ム</span>:&nbsp;&nbsp;<?php echo $arc['gmy'];?></li>
      <li><span style="letter-spacing:8px;">プール</span>:&nbsp;&nbsp;<?php echo $arc['swimming'];?></li>
      <li><span>適合対象</span>:&nbsp;&nbsp;<?php echo $arc['shobject'];?></li>
      <li class="double_liwh xxprices">家賃&nbsp;:&nbsp;3000元/月</li>
    </ul>
  </div>
  <div class="jiaotong">
  ...
  <div class="zhoubian">
    ...
    <ul>
      <li class="double_liwh"><span style="letter-spacing:8px;">スパー</span>:&nbsp;&nbsp;<?php echo $arc['supermarket'];?></li>
      ...
      <li class="double_liwh"><span>病&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;院</span>:&nbsp;&nbsp;<?php echo $arc['hospital'];?></li>
    </ul>
...
<p style="text-align:center;"><input type="image" src="../share/images/dayin.png" id="biuuu_button"  /></p>
