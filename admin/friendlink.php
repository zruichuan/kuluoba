...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  ...
  ?>
        <tr onMouseOver="this.className='relow'" onMouseOut="this.className='row'" class="row">
          ...
          <td align="center"><a href="<?php echo $list['../../PHPAACMS/admin/url'];?>" target="_blank" title="打开网址"><?php echo $list['url'];?></a>&nbsp;</td>
          <td align="center"><?php if(!empty($list['logo'])){?>
            <img src="<?php echo $list['../../PHPAACMS/admin/logo'];?>" width="120" height="26">
            <?php }?>
          &nbsp;</td>
