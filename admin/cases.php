...
$sql_string = "select a.*,b.name as cname,c.username from cms_case a 
			left outer join cms_casecategory b on a.cid=b.id
			left outer join cms_users c on a.created_by=c.userid
			where ".$where." order by a.id desc";
$total_nums = $db->getRowsNum ( $sql_string );
$mpurl 	= "cases.php?id=" . $id."&keywords=".$keywords;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td valign="top" style="padding:10px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="serach">
        <tr>
          <td height="40"><form method="get" action="cases.php" style="margin:0">
...
  </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_head">
        <tr>
          ...
          <td align="right"><select name="select" onChange="window.location.href='cases.php?id='+this.value">
              <option value="0">--所有栏目--</option>
              <?php getcaseCategorySelect ($id)?>
                    </select>
            <input type="button" value="添加文章" onClick="location.href='cases.add.php?act=add&cid=<?php echo $id;?>'" class="submit"></td>
        </tr>
      </table>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
        ...
        <tr onMouseOver="this.className='relow'" onMouseOut="this.className='row'" class="row">
          ...
          <td height="26"><a
			href="cases.add.php?act=edit&id=<?php echo $al ['id'];?>&region=<?php echo $al ['region'];?>&housetype=<?php echo $al ['housetype'];?>&price=<?php echo $al ['price'];?>&atrioventricular=<?php echo $al ['atrioventricular'];?>&subway=<?php echo $al['subway'] ?>&xxarea=<?php echo $al['xxarea']?>&yugang=<?php echo $al['yugang'] ?>"> <?php echo $al ['title'];?> </a>&nbsp;</td>
          ...
          <td height="26" align="center"><a
			href="cases.add.php?act=edit&id=<?php echo $al ['id'];?>&region=<?php echo $al ['region'];?>&housetype=<?php echo $al ['housetype'];?>&price=<?php echo $al ['price'];?>&atrioventricular=<?php echo $al ['atrioventricular'];?>&subway=<?php echo $al['subway'] ?>&xxarea=<?php echo $al['xxarea']?>&yugang=<?php echo $al['yugang'] ?>"><img
			src="images/edit.gif" title="修改" alt="修改" border="0"></a>&nbsp;<a
			href="cases.add.php?act=coby&id=<?php echo $al ['id'];?>&region=<?php echo $al ['region'];?>&housetype=<?php echo $al ['housetype'];?>&price=<?php echo $al ['price'];?>&atrioventricular=<?php echo $al ['atrioventricular'];?>&subway=<?php echo $al['subway'] ?>&xxarea=<?php echo $al['xxarea']?>&yugang=<?php echo $al['yugang'] ?>"><img src="images/coby.png" title="拷贝" alt="拷贝"/></a>&nbsp;<img src="images/del.gif" title="删除" alt="删除"
